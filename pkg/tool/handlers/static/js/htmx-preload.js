...
htmx.defineExtension("preload", {
    ...
    onEvent: function(name, event) {
        ...
        // TODO: this is custom to support loading the current node
        if (event.target.hasAttribute("preload")) {
            init(event.target)
            event.target.querySelectorAll("a,[hx-get],[data-hx-get]").forEach(init)
        }
